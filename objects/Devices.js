var Devices = function() {
  ...
  var allDevices = element.all(by.repeater('device in devices'));
  ...
  this.selectSingleDeviceEdit = function(position){
    allDevices.element(by.linkText('EDIT')).click();
      //  then(function(devices,position){
      //devices.element(by.linkText('EDIT')).click();
    //});
  };
   ...
   */
  this.get = function() {
    browser.get('http://localhost:9000/#/devices');
    //login.get();
